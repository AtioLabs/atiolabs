...
export default function EndYourDay() {
  return (
    <section id="end-your-day" className="section framer-reveal" style={{ borderTop: "1px solid var(--border-color)", borderBottom: "1px solid var(--border-color)" }}>
